...
namespace ToCBooks.App.Migrations
{
    ...
    [Migration("20200927174130_Pedido2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToCBooks.App.Business.Models.CupomModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ToCBooks.App.Business.Models.PedidoModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ToCBooks.App.Business.Models.CartaoCreditoPedido", b =>
                {
                    b.HasOne("ToCBooks.App.Business.Models.CartaoCreditoModel", "CartaoCredito")
                        .WithOne("CartaoCreditoPedido")
                        .HasForeignKey("ToCBooks.App.Business.Models.CartaoCreditoPedido", "CartaoCreditoID");

                    b.HasOne("ToCBooks.App.Business.Models.PedidoModel", "Pedido")
                        .WithOne("CartaoCreditoPedido")
                        .HasForeignKey("ToCBooks.App.Business.Models.CartaoCreditoPedido", "PedidoId");
                });
            ...
            modelBuilder.Entity("ToCBooks.App.Business.Models.PedidoModel", b =>
                {
                    ...
                    b.HasOne("ToCBooks.App.Business.Models.CupomModel", "CupomDesconto")
                        .WithMany()
